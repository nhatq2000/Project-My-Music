  ...
  <div class="swiper-container slideshow">
    ...
    <div class="swiper-wrapper">
      ...
      <div class="swiper-slide slide">
        <div class="slide-image" style="background-image: url(picture/haytraochoanh.jpg)"></div>
        <span class="slide-title">Hãy trao cho anh</span>
      </div>

      <div class="swiper-slide slide">
        <div class="slide-image" style="background-image: url(picture/songgio.jpg"></div>
        <span class="slide-title">Simple love</span>
      </div>

      <div class="swiper-slide slide">
        <div class="slide-image" style="background-image: url(picture/congidauhonchudatung.jpg"></div>
        <span class="slide-title">còn gì đau hơn chữ đã từng</span>
      </div>
